  ...
  methods: {
    initArticle() {
      ...
      if (articleId) {
        ...
        this.axios.get("/api/blog/" + articleId).then(({ data }) => {
    ...
    listCategories() {
      this.axios.get("/api/type/admin/search").then(({ data }) => {
        this.typeList = data.data;
      });
    },
    listTags() {
      this.axios.get("/api/tag/admin/search").then(({ data }) => {
    ...
    saveOrUpdateArticle() {
      ...
      // }
      this.axios
        .post("/api/blog/admin/saveOrUpdate", this.article)
        .then(({ data }) => {
          if (data.flag) {
            this.$notify.success({
              title: "成功",
