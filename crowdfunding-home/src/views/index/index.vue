  ...
  <div>
    ...
    <section class="feature-project-03 grey-bg pt-125 pb-130">
      <div class="container custom-container-4">
        ...
        <div class="row">
          <div v-for="item in dataList" :key="item.projectId">
          <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="projects projects__03 pos-rel mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
              ...
              <img v-bind:src=item.headPic alt="" height="268">
                  ...
                  <ul class="project-manager">
                    <li>
                      <a>
                        ...
                        <span>{{item.homeUserName}}</span></a></li>
                    <li>
                      <p class="time">
        ...
        <div class="row">
          ...
          <div class="col-xl-6 col-lg-6">
            <div class="faq-content mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
              <div id="accordion">
                <div >
                <div v-for="item in dataList2" :key="item.id" class="card card-bg mb-15" style="background-image:url(../../assets/images/bg/06.jpg)">
...
export default {
  ...
  methods: {
    getHomeCount() {
      axios.get("/api/home/index/homeCount").then(({data}) => {
        this.homeUserCount = data.data
      })
    },
    getProCount() {
      axios.get("/api/home/index/proCount").then(({data}) => {
        this.projectPrice = data.data
      })
    },
    getProList() {
      axios.get("/api/home/index/list").then(({data}) => {
        this.dataList = data.data
      })
    },
    getCommonProblems() {
      axios.get("/api//home/index/commonProblems").then(({data}) => {
