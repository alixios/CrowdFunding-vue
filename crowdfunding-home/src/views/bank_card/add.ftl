...
<body>
    ...
    <div class="box-container">
        ...
        <div class="layui-form">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button type="submit" class="layui-btn" lay-submit="" id="add-bankcard" lay-filter="add-bankcard" onclick="M.addBankCard()">提交</button>
...
<script>
   ...
   init();
    ...
    M.addBankCard = function () {
        ...
        if(msg.isBankCard(cardNumbers,M.bank)){
            var flag = false;
            $.ajax({
                dataType: 'json',
                async: false,
